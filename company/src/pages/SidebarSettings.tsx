...
const ALL_PAGES = [
  ...
  { id: 'attendance', label: 'Attendances & Time Off' },
  { id: 'roles', label: 'Users & Companies' },
  { id: 'vans', label: 'Fleet' },
  { id: 'salesmen', label: 'Sales Teams' },
  { id: 'warehouses', label: 'Locations & Warehouses' },
  { id: 'products', label: 'Products & Variants' },
  { id: 'categories', label: 'Product Categories' },
  { id: 'units', label: 'Units of Measure (UoM)' },
  { id: 'stock-adjustment', label: 'Inventory Adjustments' },
  { id: 'valuation', label: 'Inventory Valuation' },
  { id: 'inventory-settings', label: 'Configuration' },
  { id: 'raw-materials', label: 'Bill of Materials (BOM)' },
  { id: 'raw-material-purchases', label: 'Purchase Orders (PO)' },
  { id: 'production-orders', label: 'Manufacturing Orders (MO)' },
  { id: 'customers', label: 'Customers' },
  { id: 'leads', label: 'CRM / Pipeline' },
  { id: 'tasks', label: 'Activities' },
  { id: 'quotes', label: 'Quotations' },
  { id: 'direct-sales', label: 'Point of Sale (POS)' },
  { id: 'sales-history', label: 'Sales Orders' },
  { id: 'returns', label: 'Credit Notes / Refunds' },
  { id: 'cash', label: 'Payment Collections' },
  ...
  { id: 'reports', label: 'Sales Analysis' },
  { id: 'deep-report', label: 'Advanced Analytics' },
  { id: 'online-store-settings', label: 'eCommerce Configuration' },
  { id: 'online-orders', label: 'Web Orders' },
  { id: 'settings', label: 'General Settings' },
  { id: 'sidebar-settings', label: 'User Interface' },
]
