    ...
    <PermissionProvider>
      <Routes>
        ...
        <Route path="/" element={isAuthenticated ? <Layout /> : <Navigate to="/login" />}>
          ...
          <Route path="tasks" element={<ProtectedRoute permission={PERMISSIONS.VIEW_ORDERS}><Activities /></ProtectedRoute>} />
          <Route path="leads" element={<ProtectedRoute permission={PERMISSIONS.VIEW_LEADS}><Leads /></ProtectedRoute>} />
          <Route path="returns" element={<ProtectedRoute permission={PERMISSIONS.VIEW_RETURNS}><CreditNotes /></ProtectedRoute>} />
          <Route path="quotes" element={<ProtectedRoute permission={PERMISSIONS.VIEW_QUOTES}><Quotations /></ProtectedRoute>} />
          <Route path="direct-sales" element={<ProtectedRoute permission={PERMISSIONS.VIEW_DIRECT_SALES}><PointOfSale /></ProtectedRoute>} />
          <Route path="sales-history" element={<ProtectedRoute permission={PERMISSIONS.VIEW_DIRECT_SALES}><SalesOrders /></ProtectedRoute>} />
          <Route path="deep-report" element={<ProtectedRoute permission={PERMISSIONS.VIEW_DEEP_REPORT}><DeepReport /></ProtectedRoute>} />
          <Route path="cash" element={<ProtectedRoute permission={PERMISSIONS.VIEW_COLLECTIONS}><PaymentCollections /></ProtectedRoute>} />
